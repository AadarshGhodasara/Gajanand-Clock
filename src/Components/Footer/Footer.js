      ...
      <div className="footer-content-tag">
        <div className="first-content-tag">
          ...
          <div className="footer-address-tag">
            ...
            <a href="tel:+917435820724" style={{ color: "white" }}>
              +91 74358 20724
            </a>
          </div>
          <div className="footer-address-tag">
            ...
            <a href="mailto:gajanandframe@gmail.com" style={{ color: "white" }}>
              gajanandframe@gmail.com
            </a>
          </div>
        </div>
        <div className="second-tag">
          ...
          <p>
            If any clients want to order in big chunk then, Gajanand clock
            happily eager to accept the order though products are not being
